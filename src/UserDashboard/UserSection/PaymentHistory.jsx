...
const PaymentHistory = () => {
    ...
    return (
        <div>
            ...
            <SectionHead  sectionPar='---Check it out---' sectionhead='PAYMENT HISTORY'></SectionHead>
            </div>
            ...
            {payments.map((payment, index) => (
              <div className="px-8 border border-b-gray-200" >
                ...
                <p className="grid md:grid-cols-12">
                  <p className="  col-span-1 py-3 mt-[8px] ">
                    {index + 1}
                  </p>
                  ...
                  <p className="md:col-span-1  py-3 mt-[8px] ">{payment.status}</p>
                  <p className="md:col-span-2  py-3 mt-[8px] ">{payment.date}</p>
                </p>
              </div>
            ))}
          </div>
            ...
            <div>
              ...
              {payments.map((payment, index) => (
                <div className=" p-2 border border-b-gray-200" >
                  {/* row 1 */}
                  <p className="">
                    <p className="bg-green-400 py-1 text-center text-white">{index + 1}</p>
                    <div className="">
