...
export const AdminUser = () => {
  ...
  return (
    <div>
      ...
      <SectionHead  sectionPar="---HURRY---" sectionhead="ADMIN USERS" />
      </div>
      ...
      <div className="">
            <div className="grid md:grid-cols-12 grid-cols-7 bg-orange-400 text-white border-none md:px-8 px-2 py-2">
